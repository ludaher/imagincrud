...
homeModule.controller("FormController", function ($scope, $http) {
    $scope.seachEntity = {
        Name: '', CustomerId: '', TotalPages: 0, Page: 1, ItemsByPage: "10",
    ...
    $scope.find = function () {
        var formData = {
            searchModel: {
                ...
                EntityToFind: { Name: $scope.seachEntity.Name, CustomerId: $scope.seachEntity.CustomerId }
            }
        };
        $http.post(getCustomersView, formData)
